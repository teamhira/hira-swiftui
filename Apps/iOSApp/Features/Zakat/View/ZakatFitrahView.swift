...
public struct ZakatFitrahView: View {
    ...
    public var body: some View {
            ...
            ScrollView(showsIndicators: false) {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        Text(appEnv.language.localizedString("zakat_desc_fitrah"))
                            .font(.caption)
                    ...
                    // Calculation Input (Multi-field)
                    VStack(alignment: .leading, spacing: 20) {
                        VStack(alignment: .leading, spacing: 8) {
                            Text(appEnv.language.localizedString("zakat_label_people"))
                            ...
                            TextField("0", text: $viewModel.currentAsset)
                                ...
                                .accessibilityLabel(appEnv.language.localizedString("zakat_label_people"))
                        }
                        ...
                        VStack(alignment: .leading, spacing: 8) {
                            ...
                            TextField("45000", text: $viewModel.assetPrice)
                                .padding()
                                .background(colors.foreground.opacity(0.04))
                                .cornerRadius(12)
                                .keyboardType(.numberPad)
                    ...
                    if viewModel.calculatedZakat > 0 {
                        VStack(alignment: .leading, spacing: 8) {
                            ...
                            Text(String(format: appEnv.language.localizedString("zakat_result_equivalent"), Int(Double(viewModel.currentAsset) ?? 0) * 25))
                                .font(.caption2)
        ...
        .navigationTitle(appEnv.language.localizedString("zakat_title_fitrah"))

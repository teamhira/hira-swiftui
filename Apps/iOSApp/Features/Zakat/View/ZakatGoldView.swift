...
public struct ZakatGoldView: View {
    ...
    public var body: some View {
            ...
            ScrollView(showsIndicators: false) {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        Text(appEnv.language.localizedString("zakat_desc_gold"))
                            .font(.caption)
                    ...
                    VStack(alignment: .leading, spacing: 20) {
                        VStack(alignment: .leading, spacing: 8) {
                            Text(appEnv.language.localizedString("zakat_label_grams"))
                                .font(.subheadline.bold())
                                .foregroundColor(colors.foreground)
                            
                            TextField("85", text: $viewModel.currentAsset)
                                .padding()
                                .background(colors.foreground.opacity(0.04))
                                .cornerRadius(12)
                                .keyboardType(.decimalPad)
                                .accessibilityLabel(appEnv.language.localizedString("zakat_label_grams"))
                        }
                        
                        VStack(alignment: .leading, spacing: 8) {
                            Text(appEnv.language.localizedString("zakat_label_price_gram"))
                                .font(.subheadline.bold())
                                .foregroundColor(colors.foreground)
                            
                            TextField("1200000", text: $viewModel.assetPrice)
                                .padding()
                                .background(colors.foreground.opacity(0.04))
                                .cornerRadius(12)
                                .keyboardType(.decimalPad)
                                .accessibilityLabel(appEnv.language.localizedString("zakat_label_price_gram"))
                        }
                        
                        Text(appEnv.language.localizedString("zakat_label_haul_note"))
                            .font(.caption2)
                            .foregroundColor(colors.foreground.opacity(0.4))
                        
                        Button(action: {
                            viewModel.selectedType = .emas
                            viewModel.calculate()
                            viewModel.addRecord()
                        }) {
        ...
        .navigationTitle(appEnv.language.localizedString("zakat_title_gold"))

...
public struct ZakatMiningView: View {
    ...
    public var body: some View {
            ...
            ScrollView(showsIndicators: false) {
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        Text(appEnv.language.localizedString("zakat_desc_mining"))
                            .font(.caption)
                    ...
                    // Input
                    VStack(alignment: .leading, spacing: 16) {
                        Text(appEnv.language.localizedString("zakat_label_amount"))
                        ...
                        Button(action: {
                            viewModel.selectedType = .tambang
                            viewModel.calculate()
                            viewModel.addRecord()
                        }) {
        ...
        .navigationTitle(appEnv.language.localizedString("zakat_title_mining"))
